...
urlpatterns = [
    ...
    path(
        "plants/<int:pk>/update/", views.PlantUpdate.as_view(), name="plants_update"
    ),
    path(
        "plants/<int:pk>/delete/", views.PlantDelete.as_view(), name="plants_delete"
    ),
    path(
        "plants/<int:plant_id>/add_watering/", views.add_watering, name="add_watering"
    ),
    path(
        "plants/<int:plant_id>/reset_watering/",
        views.reset_watering,
        name="reset_watering",
    ),
    path(
    ...
    path(
        "vessels/<int:pk>/update/",
        views.VesselUpdate.as_view(),
        name="vessels_update",
    ),
    path(
        "vessels/<int:pk>/delete/",
        views.VesselDelete.as_view(),
        name="vessels_delete",
    ),
